...
==========================
The CategoricalVariableImputer() replaces missing data in categorical variables with the string 'Missing'.
It works only with categorial variables. A list of variables can be indiacated, or the imputer will
