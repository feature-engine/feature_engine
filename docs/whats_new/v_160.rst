...
Thank you so much to all contributors, `Gleb Levitski <https://github.com/GLevv>`_ for helping
...
- Made code source compatible with pandas 2.0` (`Claudio Salvatore Arcidiacono <https://github.com/ClaudioSalvatoreArcidiacono>`_)
