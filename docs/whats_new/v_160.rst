...
- Routine in `DatetimeFeatures()` does not enter into our check for utc=True when working with different timezones any more, commented out, to be removed in version 1.7.0 (`Soledad Galli <https://github.com/solegalli>`_)
