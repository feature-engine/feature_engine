...
~~~~~~~~~~~~~
    ...
    - Fixes typo in `ArbitraryImputer` documentation (`Tim Vink <https://github.com/timvink>`_)
...
~~~~~~~~~~~~~~~~~
    ...
    - `MissingIndicator`: removed looping over every variable to add missing indicators. Now using `pd.isna()` (`Soledad Galli <https://github.com/solegalli>`_)
