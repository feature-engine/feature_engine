...
The WoEEncoder() replaces the labels by the weight of evidence or the ratio of
...
.. code:: python
	...
	woe_encoder = WoEEncoder(encoding_method='woe', variables=['cabin', 'pclass', 'embarked'])
