...
transformations together. Adding the cosine function, which is out of phase with respect to
the sine function, breaks the symmetry and assigns a unique codification to each hour.
...
Finally, let's visualise the (x, y) circle coordinates generated by the sine and cosine
features.
...
scikit-learn and feature-engine, and I doubt that this subtle difference will result in a big
...
Check also this Kaggle demo on the use of cyclical encoding with neural networks:
