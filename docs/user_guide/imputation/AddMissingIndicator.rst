...
In the following image, we se the result of the previous code, that is, the missing
indicators that were added to the dataframe:
...
Missing indicators are commonly used alongside random sampling, mean or median
