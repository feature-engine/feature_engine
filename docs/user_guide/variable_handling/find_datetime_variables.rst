...
:class:`find_datetime_variables()` works in the same way with a polars dataframe.
...
The dataframe has 3 datetime variables: two of them are native polars `Datetime`
columns, and one, `date3`, is an ISO-8601 string. Let's capture all 3:
