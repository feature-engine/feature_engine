...
from feature_engine.feature_selection import DropFeatures, DropConstantFeatures, SimilarColumns

def test_similar_columns_when_more_columns_in_train_than_test(dataframe_vartypes, dataframe_na):

    # When columns are the same
    train = dataframe_na.copy()
    test = dataframe_vartypes.copy()
...
def test_similar_columns_when_more_columns_in_test_than_train(dataframe_vartypes, dataframe_na):

    # When columns are the same
    train = dataframe_vartypes
    test = dataframe_na
...
def test_drop_constant_features_with_list_of_variables(dataframe_constant_features):
...
def test_drop_constant_features_if_fit_input_not_dataframe():
...
def test_drop_constant_features_errors_if_input_constant_and_quasi_constant_features():
...
def test_drop_constant_features_if_fit_not_called(dataframe_constant_features):
