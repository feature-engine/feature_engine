...
def test_discretiser_for_classification(dataframe_normal_dist):
...
def test_discretiser_for_regression(dataframe_normal_dist):
...
def test_raises_error_when_cv_is_string():
    with pytest.raises(ValueError):
        DecisionTreeDiscretiser(cv='other')


def test_raises_error_when_regression_is_not_bool():
    with pytest.raises(ValueError):
        DecisionTreeDiscretiser(regression='other')


def test_raises_error_if_y_not_passed(dataframe_normal_dist):
