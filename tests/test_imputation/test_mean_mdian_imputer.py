...
def test_mean_imputation_and_automatically_select_variables(dataframe_na):
    # set up transformer
...
def test_median_imputation_when_user_enters_single_variables(dataframe_na):
    # set up trasnformer
...
def test_raises_error_with_wrong_imputation_method_parameter():
