...
def test_threshold_with_variables(df_na):
    ...
    imputer = DropMissingData(missing_only=False, threshold=1, variables=["Marks"])
    X = imputer.fit_transform(df_na)
