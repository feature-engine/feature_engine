...
def test_gaussian_right_tail_capping_when_fold_is_1(dataframe_normal_dist):
...
def test_gaussian_both_tails_capping_with_fold_2(dataframe_normal_dist):
...
def test_iqr_left_tail_capping_with_fold_2(dataframe_normal_dist):
