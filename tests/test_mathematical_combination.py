...
from feature_engine.mathematical_combination import MathematicalVariableCombinator


def test_MathematicalVariableCombinator_all(dataframe_vartypes):
    transformer = MathematicalVariableCombinator()
...
def test_MathematicalVariableCombinator_SelectedVariables(dataframe_vartypes):
    transformer = MathematicalVariableCombinator(variables=['Age', 'Marks'])
...
def test_MathematicalVariableCombinator_SelectedVariables_NonNumeric(dataframe_vartypes):
    transformer = MathematicalVariableCombinator(variables=['Name', 'Age', 'Marks'])
...
def test_MathematicalVariableCombinator_SelectedOperations(dataframe_vartypes):
    transformer = MathematicalVariableCombinator(math_operations=['sum', 'mean'])
