...
def test_find_cat_and_num_variables_empty_warn(df_empty):
    cat_vars, num_vars = find_categorical_and_numerical_variables(df_empty(), allow_empty=True)
    assert cat_vars == []
    assert num_vars == []
...
def test_find_cat_and_num_variables_single_variable_warn(df_empty):
    ...
    cat_vars, num_vars = find_categorical_and_numerical_variables(df_invalid, variables="col", allow_empty=True)
    assert cat_vars == []
    assert num_vars == []
