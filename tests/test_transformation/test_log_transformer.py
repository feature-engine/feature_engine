...
def test_log_base_e_plus_automatically_find_variables(dataframe_vartypes, dataframe_na):
...
def test_log_base_10_plus_user_passes_var_list(dataframe_vartypes):
