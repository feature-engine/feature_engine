...
class TransformerMixin:
    """
    Mixin class for all transformers in scikit-learn. Taken from sklearn==1.1.0

    In version 1.2.0 they incorporated the method set_output to return pandas
    dataframe, and it messes up the documentation.
    """
