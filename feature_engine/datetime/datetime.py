...
class DatetimeFeatures(BaseEstimator, TransformerMixin):
    ...
    ***
    ...
    drop_constant: bool, default="True"
        Whether to drop extracted datetime features that are constant
        (e.g. time features extracted from a date-only variable).
        Note: constant features that are present in the dataset but
        are not generated by this transformer will not be dropped,
        including datetime features that are retained when drop_datetime
        is set to False.
